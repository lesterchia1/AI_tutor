...
# Main UI
st.title("📚 AI Tutor - We.(POC)")
st.markdown("An interactive Personal AI Tutor chatbot to help with your learning needs.")

# Create tabs
tab1, tab2, tab3 = st.tabs(["🤖 AI Chatbot", "📄 Upload & Quiz", "🎥 Introduction Video"])
...
with tab1:
    ...
    with st.expander("🎤 Voice Recording Tips", expanded=False):
        st.markdown("""
...
with tab3:
    ...
    st.markdown("Music from Xu Mengyuan - China-O, musician Xu Mengyuan YUAN! | 徐梦圆 - China-O 音乐人徐梦圆YUAN!")
